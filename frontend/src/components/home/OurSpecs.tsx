import { ourSpecsData } from '../../assets/assest';
...
const OurSpecs = () => {
  return (
    <div className="px-6 my-20 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 gap-y-10 mt-26 text-text">
        {ourSpecsData.map((spec, index) => {
          return (
            <div
              ...
              key={index}
            >
              <h3 className="text-text font-medium">{spec.title}</h3>
              <p className="text-sm text-text-secondary mt-3">{spec.description}</p>
              <div
