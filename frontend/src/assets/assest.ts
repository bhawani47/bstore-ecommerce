...
export const productDummyData = [
  {
    ...
    rating: dummyRatingsData.map(r => ({ ...r, rating: 4.3 })),
  ...
  },
  {
    ...
    store: dummyStoreData,
    category: "Speakers",
    rating: dummyRatingsData.map(r => ({ ...r, rating: 4.7 })),
  ...
  },
  {
    ...
    store: dummyStoreData,
    category: "Watch",
    rating: dummyRatingsData.map(r => ({ ...r, rating: 4.5 })),
  ...
  },
  {
    ...
    store: dummyStoreData,
    category: "Headphones",
    rating: dummyRatingsData.map(r => ({ ...r, rating: 4.8 })),
  ...
  },
  {
    ...
    store: dummyStoreData,
    category: "Watch",
    rating: dummyRatingsData.map(r => ({ ...r, rating: 4.4 })),
  ...
  },
  {
    ...
    store: dummyStoreData,
    category: "Camera",
    rating: dummyRatingsData.map(r => ({ ...r, rating: 4.6 })),
    createdAt: 'Sat Jul 25 2025 14:51:25 GMT+0530 (India Standard Time)',
    updatedAt: 'Sat Jul 25 2025 14:51:25 GMT+0530 (India Standard Time)',
  },
  {
